...
export class AuthPageComponent implements OnInit {
  ...
  @ViewChild("socialSignupModal", { static: false })
  socialSignupModal: SocialSignModalComponent;
  ...
  onSignUpNow() {
    ...
    var stripe = window["Stripe"](environment.publishable_key);
  ...
  openDialog(userData): void {
    ...
    const dialogRef = this.dialog.open(SocialSignModalComponent, {
      data: { userData, industryData: this.industryData },
    });
